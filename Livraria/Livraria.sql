...
CREATE TABLE livro 
    (
        ...
        ano DATETIME NOT NULL CHECK (ano >= 1990) PRIMARY KEY (codigo)
    )
...
CREATE TABLE autor 
    (
        ...
        biografia VARCHAR(255) NOT NULL PRIMARY KEY (id_autor)
    )
...
CREATE TABLE editora
    (
        ...
        complemento_endereco VARCHAR(255) PRIMARY KEY (id_editora)
    )
