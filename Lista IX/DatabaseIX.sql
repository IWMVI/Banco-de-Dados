CREATE DATABASE ex9 GO
USE ex9 GO
CREATE TABLE editora
(
  codigo INT         NOT NULL,
  nome   VARCHAR(30) NOT NULL,
  site   VARCHAR(40) NULL PRIMARY KEY (codigo)
) GO
CREATE TABLE autor
(
  codigo    INT          NOT NULL,
  nome      VARCHAR(30)  NOT NULL,
  biografia VARCHAR(100) NOT NULL PRIMARY KEY (codigo)
) GO
...
(
  ...
  codAutor   INT           NOT NULL PRIMARY KEY (codigo) FOREIGN KEY (codEditora) REFERENCES editora (codigo),
...
(
  ...
  dataCompra  DATE          NOT NULL PRIMARY KEY (codigo, codEstoque, dataCompra) FOREIGN KEY (codEstoque) REFERENCES estoque (codigo)
) GO
INSERT INTO
  editora
VALUES
  ...
  (6, 'Moderna', 'www.moderna.com.br') GO
INSERT INTO
  autor
VALUES
  (
  ...
  (
    103,
    'Diva Marilia Flemming',
    'Professora adjunta da UFSC'
  ),
  (
    104,
    'David Halliday',
    'Ph.D. da University of Pittsburgh'
  ),
  (
    105,
    'Alfredo Steinbruch',
    'Professor de Matematica da UFRS e da PUCRS'
  ),
  (
    106,
    'Willian Roberto Cereja',
    'Doutorado em Linguistica Aplicada e Estudos da Linguagem'
  ),
  (
    107,
    'William Stallings',
    'Doutorado em Ciencias da Computac�o pelo MIT'
  ),
  (
    108,
    'Carlos Morimoto',
    'Criador do Kurumin Linux'
  ) GO
INSERT INTO
  estoque
VALUES
  ...
  (10008, 'Calculo B', 3, 95.00, 3, 103) GO
INSERT INTO
  compra
VALUES
