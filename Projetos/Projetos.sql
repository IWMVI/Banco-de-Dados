...
ALTER TABLE users ADD CONSTRAINT UQ_users_NomeUsuario UNIQUE (nomeusuario)

ALTER TABLE users

ALTER COLUMN senha VARCHAR(8) EXEC sp_help users

INSERT INTO
    users (nome, nomeusuario, email)
VALUES
    ('Maria', 'Rh_maria', 'maria@empresa.com')

INSERT INTO
    users (nome, nomeusuario, senha, email)
VALUES
    (
        'Paulo',
        'Ti_paulo',
...
INSERT INTO
    projects (nome, descricao, dataproj)
VALUES
    (
        'Re-folha',
        'Refatoração das Folhas',
        '2014-09-05'
    )
...
INSERT INTO
    projects (nome, dataproj)
VALUES
    ('Auditoria', '2014-09-07')

INSERT INTO
    user_has_projects (users_id, projects_id)
VALUES
    (1, 10001)
